...
public class ToolboxPanel extends JPanel {
    ...
    private ValidatingTextField gapToleranceTextField = new ValidatingTextField("",
            ...
            new ValidatingTextField.BlankCleaner("1.0"));
    private JTabbedPane resultsTabbedPane = new JTabbedPane();
    private JButton findGapsButton = new JButton("Find Gaps",
            IconLoader.icon("BlueFlag.gif"));
    ...
    private ValidatingTextField angleToleranceTextField = new ValidatingTextField("",
            5, SwingConstants.RIGHT,
            new ValidatingTextField.BoundedDoubleValidator(0, false, 180, false),
            new ValidatingTextField.BlankCleaner("22.5"));
    private JLabel degreesLabel = new JLabel();
    private TableTab gapsTab = new TableTab("Gaps", "LENGTH",
            resultsTabbedPane, "Find Gaps");
    private TableTab autoFixedTab = new TableTab("Auto-Fixed", "LENGTH",
            resultsTabbedPane, "Fix Gaps");
    private TableTab overlapsTab = new TableTab("Overlaps", null,
    ...
    private LayerDependencyManager layerDependencyManager = new LayerDependencyManager(new TableTab[] {
                gapsTab, overlapsTab
            }, inputLayerComboBox) {
    ...
    public ToolboxPanel(WorkbenchContext context) {
        try {
            ...
            jbInit();
            inputLayerComboBox.getModel().addListDataListener(new ListDataListener() {
                    ...
                    public void contentsChanged(ListDataEvent e) {
                        if ((e.getIndex0() == -1) && (e.getIndex1() == -1)) {
                            //A new item has been selected. Better than #actionPerformed,
                            //which doesn't catch calls to #setSelectedItem. [Jon Aquino]
                            outputLayerTextField.setText((inputLayerComboBox.getSelectedLayer() == null)
                                ? ""
                                : ((inputLayerComboBox.getSelectedLayer()
                                                      .getBlackboard().get(MainButtonPlugIn.GENERATED_KEY) != null)
                                ? inputLayerComboBox.getSelectedLayer().getName()
                                : (inputLayerComboBox.getSelectedLayer()
                                                     .getName() + " (cleaned)")));
                        }
                    }
                });
            findGapsButton.addActionListener(AbstractPlugIn.toActionListener(
                    new FindGapsPlugIn(this), context, new TaskMonitorManager()));
            findOverlapsButton.addActionListener(AbstractPlugIn.toActionListener(
                    new FindOverlapsPlugIn(this), context,
    ...
    void jbInit() throws Exception {
        ...
        fixAutomaticallyCheckBox.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    fixAutomaticallyCheckBox_actionPerformed(e);
                }
            });
        findGapsTab.add(upperPanel,
            new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
                new Insets(0, 0, 0, 0), 0, 0));
        upperPanel.add(gapToleranceLabel,
            new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
        upperPanel.add(angleToleranceLabel,
            new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
        upperPanel.add(gapToleranceTextField,
        ...
        findGapsTab.add(findGapsButton,
            new GridBagConstraints(0, 3, 1, 1, 1.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                new Insets(4, 4, 4, 4), 0, 0));
        findOverlapsTab.add(findOverlapsButton,
        ...
        upperPanel.add(outputLayerLabel,
            new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
        upperPanel.add(outputLayerTextField,
            new GridBagConstraints(1, 5, 1, 1, 1.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
                new Insets(0, 0, 0, 0), 0, 0));
        upperPanel.add(angleTolerancePanel,
        ...
        angleTolerancePanel.add(angleToleranceTextField,
            new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
                ...
                new Insets(0, 0, 0, 0), 0, 0));
        angleTolerancePanel.add(degreesLabel,
            new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
        upperPanel.add(fixAutomaticallyCheckBox,
        ...
        this.add(inputLayerPanel,
            new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.NORTHWEST, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
        inputLayerPanel.add(inputLayerLabel,
            new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
        inputLayerPanel.add(inputLayerComboBox,
            new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
    }
    ...
    public class TableTab extends Tab {
        ...
        public TableTab(String basicTitle, String sortAttributeName,
        ...
        public TableTab setLayer(Layer layer, WorkbenchContext context) {
            ...
            ((OneLayerAttributeTab) getChild()).setLayer(layer);

            if (sortAttributeName != null) {
                ((OneLayerAttributeTab) getChild()).getLayerTableModel().sort(sortAttributeName,
                    false);
            }
        ...
        private OneLayerAttributeTab createAttributeTab(
            WorkbenchContext context) {
            return new OneLayerAttributeTab(context,
                (TaskFrame) context.getWorkbench().getFrame()
        ...
        public void updateTitle() {
            ...
            if (isOutOfDate()) {
                String errorMessage = getChild() instanceof OneLayerAttributeTab
                    ? "These results may be out of date. Please re-run " +
                    associatedOperation + "."
        ...
        private String getTitle() {
            ...
            if (getChild() instanceof OneLayerAttributeTab) {
                ...
                ? ("(" +
                attributeTab.getLayer().getFeatureCollectionWrapper().size() +
                ")") : "(0)");
            } else {
                title += "";
            }
